...
export function parseKvNamespacesFromCfg(cfg, configRel = "wrangler config") {
  ...
  // preview_id is a Wrangler `wrangler dev` concept WDL doesn't use; allow it
  // (ignored) but reject other unknown keys, matching the d1/r2 parsers.
  const allowedKeys = new Set(["binding", "id", "preview_id"]);
