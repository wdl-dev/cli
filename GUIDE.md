...
| `control did not confirm session_policy = restart`                          | The control plane predates `[wdl] session_policy`                                                                   | Upgrade control; the version was uploaded but not promoted, and re-running the same deploy cannot help                  |
