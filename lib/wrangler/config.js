...
/**
 * Build the config passed to Wrangler's dry-run bundler. WDL consumes these
 * private extensions itself, so Wrangler must not interpret or validate them.
 * The source config stays untouched because WDL still needs the full shape for
 * its deploy manifest.
